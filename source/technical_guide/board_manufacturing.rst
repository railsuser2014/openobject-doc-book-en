...
You can download this module as a zip file in the following version:
  ...
  * `4.2 </download/modules/4.2/board_manufacturing.zip>`_
  * `5.0 </download/modules/5.0/board_manufacturing.zip>`_
  * `trunk </download/modules/trunk/board_manufacturing.zip>`_
