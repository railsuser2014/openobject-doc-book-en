...
You can download this module as a zip file in the following version:
  ...
  * `4.2 </download/modules/4.2/profile_accounting.zip>`_
  * `5.0 </download/modules/5.0/profile_accounting.zip>`_
  * `trunk </download/modules/trunk/profile_accounting.zip>`_
