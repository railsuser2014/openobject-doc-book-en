...
That is not the case in Open ERP. To automatically make Open ERP reports available in the FTP server,
...
.. note:: Virtual Files
    ...
    Virtual files do not actually exist in Open ERP but are made visible with a size of 0 in the FTP
    server.
    ...
    You do not then have to go and print a document through Open ERP –
...
re-send a quotation to a customer you do not have to open Open ERP, you can just attach the relevant
