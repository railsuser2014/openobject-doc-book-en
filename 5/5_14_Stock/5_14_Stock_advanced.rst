...
You've seen that most OpenERP documents can be changed in a planning view. It's the same for
...
OpenERP supports three approaches to controlling data entry on products ordered from suppliers:
...
If you use Supplier Orders in OpenERP, product receipts are automatically generated by the system
...
manually you can click the button at the lower right :guilabel:`Products not received`. OpenERP
