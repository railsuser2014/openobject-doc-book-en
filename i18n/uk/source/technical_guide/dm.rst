...
.. i18n: .. raw:: html
.. i18n: 
.. i18n:     <div class="js-kit-rating" title="" permalink="" standalone="yes" path="/dm"></div>
...
.. i18n:               - Generate the Retro planning (automaticaly creates all the tasks necessary to launch your campaign)
...
.. i18n:   * `trunk <http://www.openerp.com/download/modules/trunk/dm.zip>`_
...
.. i18n:  * :mod:`document`
.. i18n:  * :mod:`base_report_designer`
.. i18n:  * :mod:`sale`
.. i18n:  * :mod:`base_partner_gender`
...
.. i18n:  * Direct Marketing/Configuration/Offers/Offer Steps
.. i18n:  * Direct Marketing/Configuration/Offers/Offer Steps/All Offer Step Types
.. i18n:  * Direct Marketing/Configuration/Offers/Offer Steps/All Offer Steps
.. i18n:  * Direct Marketing/Configuration/Offers/Offer Steps/All Transition Triggers
.. i18n:  * Direct Marketing/Configuration/Offers/Offer Steps/All Medias
.. i18n:  * Direct Marketing/Configuration/Offers/Offer Steps/All Offer Step Action
.. i18n:  * Direct Marketing/Configuration/Campaigns
.. i18n:  * Direct Marketing/Configuration/Customers Lists
.. i18n:  * Direct Marketing/Campaigns
.. i18n:  * Direct Marketing/Configuration/Low Level
.. i18n:  * Direct Marketing/Configuration/Low Level/Campaign Documents
...
.. i18n:  * Direct Marketing/Configuration/Customers Lists/All Customers Lists Brokers
.. i18n:  * Direct Marketing/Configuration/Customers Lists/All Deduplicator
...
.. i18n:  * Direct Marketing/Configuration/Customers Lists/All Customers Lists
.. i18n:  * Direct Marketing/Configuration/Customers Lists/All Customers List Type
.. i18n:  * Direct Marketing/Configuration/Customers Lists/All Customers List Recruiting Origin
.. i18n:  * Direct Marketing/Configuration/Low Level/Campaign Documents/All Campaign Document Types
.. i18n:  * Direct Marketing/Configuration/Low Level/Campaign Documents/All Campaign Documents
.. i18n:  * Direct Marketing/Configuration/Customers Lists/All Customers Files
.. i18n:  * Direct Marketing/Configuration/Campaigns/Overlay Payment Rule
...
.. i18n:  * Direct Marketing/Configuration/Customers/All Customers Genders
.. i18n:  * Direct Marketing/Configuration/Low Level/All Workitems
.. i18n:  * Direct Marketing/Configuration/Customers/All Segmentations
.. i18n:  * Direct Marketing/Configuration/Low Level/Edit Events
.. i18n:  * Direct Marketing/Configuration/Campaigns/All Trademarks
.. i18n:  * Direct Marketing/Configuration/Documents
.. i18n:  * Direct Marketing/Configuration/Documents/Edit DTP Documents Categories
.. i18n:  * Direct Marketing/Configuration/Documents/All DTP Documents
.. i18n:  * Direct Marketing/Configuration/Documents/All DTP Plugins Template
.. i18n:  * Direct Marketing/Configuration/Documents/All DTP Plugins
.. i18n:  * Direct Marketing/Configuration/Customers/All Plugins Values
.. i18n:  * Direct Marketing/Configuration/Mail Service
.. i18n:  * Direct Marketing/Configuration/Mail Service/All Mail Services
...
.. i18n:  * \* INHERIT ir.actions.server.inherit (form)
.. i18n:  * dm.offer.step.action.form (form)
.. i18n:  * dm.offer.step.action.tree (tree)
...
.. i18n:  * dm.campaign.document.type.form (form)
.. i18n:  * dm.campaign.document.type.tree (tree)
.. i18n:  * dm.campaign.document.form (form)
.. i18n:  * dm.campaign.document.tree (tree)
...
.. i18n:  * dm.overlay.payment_rule.form (form)
.. i18n:  * dm.overlay.payment_rule.tree (tree)
...
.. i18n:  * dm.customer.gender.form (form)
.. i18n:  * dm.customer.gender.tree (tree)
.. i18n:  * dm.worktitem.form (form)
.. i18n:  * dm.workitem.tree (tree)
.. i18n:  * dm.customer.segmentation.form (form)
.. i18n:  * dm.customer.segmentation.tree (tree)
.. i18n:  * dm.event.tree (tree)
.. i18n:  * dm.event.form (form)
...
.. i18n:  * dm.plugins.value.form (form)
.. i18n:  * dm.plugins.value.tree (tree)
.. i18n:  * dm.mail_service.form (form)
.. i18n:  * dm.mail_service.tree (tree)
...
.. i18n: :production_cost_id: Production Cost, many2one
...
.. i18n: :lang_orig_id: Original Language, many2one
...
.. i18n: :recommended_trademark_id: Recommended Trademark, many2one
...
.. i18n: Object: dm.offer.step.action (dm.offer.step.action)
.. i18n: ###################################################
...
.. i18n: :manufacturing_constraint_ids: Mailing Manufacturing Products, many2many
...
.. i18n: :seq: Step Type Sequence, integer
...
.. i18n: :floating_date: Floating date, boolean
...
.. i18n: :in_act_cond: Action Condition, text, required
...
.. i18n: :gen_next_wi: Auto Generate Next Workitems, boolean
...
.. i18n: :delay_type: Delay type, selection, required

:delay_type: Delay type, selection, required

.. i18n: :step_to_id: To Offer Step, many2one, required

:step_to_id: To Offer Step, many2one, required

.. i18n: :condition_id: Trigger Condition, many2one, required

:condition_id: Trigger Condition, many2one, required

.. i18n: :step_from_id: From Offer Step, many2one, required

:step_from_id: From Offer Step, many2one, required

.. i18n: Object: dm.overlay.payment_rule (dm.overlay.payment_rule)
.. i18n: #########################################################

Object: dm.overlay.payment_rule (dm.overlay.payment_rule)
#########################################################

.. i18n: :account_id: Account, many2one

:account_id: Account, many2one

.. i18n: :move: Move, selection
...
.. i18n: :country_default: Default for Country, boolean
...
.. i18n: :payment_method_rule_ids: Payment Method Rules, many2many
...
.. i18n: :manufacturing_product_id: Manufacturing Product, many2one
...
.. i18n: :mail_service_ids: Mailing Service, one2many
...
.. i18n:     *Choose the commercial offer to use with this campaign, only offers in ready to plan or open state can be assigned*
...
.. i18n: :campaign_type_id: Type, many2one
...
.. i18n: :initial_proposition_id: Initial proposition, many2one
...
.. i18n: :customer_pricelist_id: Product Pricelist, many2one
...
.. i18n: :price_prog_use: Price Progression, boolean
...
.. i18n: :list_type_id: Type, many2one
...
.. i18n: :recruiting_origin_id: Recruiting Origin, many2one
...
.. i18n: Object: A File of addresses (dm.customers_file)
.. i18n: ###############################################

Object: A File of addresses (dm.customers_file)
###############################################

.. i18n: :address_ids: Customers File Addresses, many2many
...
.. i18n: :case_ids: CRM Cases, many2many
...
.. i18n: :source: Source, selection, required
...
.. i18n: :start_census: Start Census, integer
...
.. i18n: :customers_file_id: Customers File, many2one
...
.. i18n: :type_census: Census Type, selection
...
.. i18n: :end_census: End Census, integer
...
.. i18n: :item_type: Product Type, selection
...
.. i18n: Object: dm.campaign.document.type (dm.campaign.document.type)
.. i18n: #############################################################
...
.. i18n: Object: dm.campaign.document (dm.campaign.document)
.. i18n: ###################################################

Object: dm.campaign.document (dm.campaign.document)
###################################################

.. i18n: :segment_id: Segment, many2one, required
...
.. i18n: :type_id: Format, many2one, required
...
.. i18n: Object: Sale Order (dm.customer.order)
.. i18n: ######################################
...
.. i18n: Object: dm.customer.gender (dm.customer.gender)
.. i18n: ###############################################
...
.. i18n: :to_gender_id: To Gender, many2one, required
...
.. i18n: :from_gender_id: From Gender, many2one
...
.. i18n: Object: workitem (dm.workitem)
.. i18n: ##############################

Object: workitem (dm.workitem)
##############################

.. i18n: :action_time: Action Time, datetime

:action_time: Action Time, datetime

.. i18n: :address_id: Customer Address, many2one

:address_id: Customer Address, many2one

.. i18n: :segment_id: Segments, many2one
...
.. i18n: :case_id: CRM Case, many2one

:case_id: CRM Case, many2one

.. i18n: :tr_from_id: Source Transition, many2one
...
.. i18n: :error_msg: System Message, text
...
.. i18n: :field_id: Customers Field, many2one
...
.. i18n: Object: Customer Order Segmentation Boolean Criteria (dm.customer.order.boolean_criteria)
.. i18n: #########################################################################################
...
.. i18n: :trigger_type_id: Trigger Condition, many2one, required

:trigger_type_id: Trigger Condition, many2one, required

.. i18n: :step_id: Offer Step, many2one, required
...
.. i18n: :store_value: Store Value, boolean
...
.. i18n: :argument_ids: Argument List, one2many
...
.. i18n: Object: Argument List (dm.plugin.argument)
.. i18n: ##########################################

Object: Argument List (dm.plugin.argument)
##########################################

.. i18n: :name: Argument Name, char, required

:name: Argument Name, char, required

.. i18n: :stored_plugin: Value from plugin, boolean

:stored_plugin: Value from plugin, boolean

.. i18n: :value: Argument Value, text
...
.. i18n: :custome_plugin_id: Plugin For Value, many2one
...
.. i18n: Object: dm.plugins.value (dm.plugins.value)
.. i18n: ###########################################
...
.. i18n: Object: dm.mail_service (dm.mail_service)
.. i18n: #########################################

Object: dm.mail_service (dm.mail_service)
#########################################

.. i18n: :unit_interval: Interval Unit, selection
...
.. i18n: :action_interval: Interval, integer

:action_interval: Interval, integer

.. i18n: :default_for_media: Default Mail Service for Media, boolean
...
.. i18n: Object: dm.campaign.mail_service (dm.campaign.mail_service)
.. i18n: ###########################################################
...
.. i18n: :mail_service_id: Mail Service, many2one
