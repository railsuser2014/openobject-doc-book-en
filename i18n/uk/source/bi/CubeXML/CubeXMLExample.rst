...
.. i18n: Before going through XML details its good to have an idea of all :ref:`Terminolgies <terminologies-link>`  of OLAP.

Before going through XML details its good to have an idea of all :ref:`Terminolgies <terminologies-link>`  of OLAP.

.. i18n: **Lets understand XML file in details**

**Lets understand XML file in details**

.. i18n: **Step: 1. The first step is to specify the database it will use with parameter like name, database name , database login and database password**
...
.. i18n: * This will create the connection parameters needed for connecting to the database.
...
.. i18n: * This will create cube name sale_order_line 
...
.. i18n: * This will used to fetch and make MDX Query on all the product 
...
.. i18n: **Step: 8  Creating Dimension res_parnter_address**
