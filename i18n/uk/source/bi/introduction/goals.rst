...
.. i18n: #. The first challenge business intelligence faces is gathering the necessary data about the business. The key for gathering data is automating the process. Gathering data was very time and money consuming in the past, but with today’s modern computer systems, it’s much easier to collect data from various sources. 
.. i18n: 
...
.. i18n: #. Provide all BI functanality. 
.. i18n: 
.. i18n: #. Creating cube on the fly with minimum steps. 
.. i18n: 
.. i18n: #. Can access any type of database to make Schema and Cube. 
.. i18n: 
