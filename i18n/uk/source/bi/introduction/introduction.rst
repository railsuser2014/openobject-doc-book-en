...
.. i18n: The Open Object Business Intelligence system aims to be a full featured open source Business Intelligence system written in Python. It implements a HOLAP (Hybride OLAP = ROLAP + MOLAP) cube and a MDX query engine based on SQLAlchemy.
...
.. i18n: * Is easy and fast to use: a simple web-interface that does not require any dependencies and can be integrated in proprietary softwares, and an OpenOffice interface for complex dashboards creation.
.. i18n: * Is easy to install: auto-installation on Windows and Linux, a few dependencies
.. i18n: * Integrated and independent from Open  ERP. 
...
.. i18n: * A cube designer within Open  ERP (application and web-client)
.. i18n: * Easy to configure: Automatic cube definition (5 clicks, using introspection on database),
.. i18n: * Easy to maintain: the application must be smart enough that do not require any fine tuning in the cube definition: run well on bad indexes, no need to explicitly define aggregated table, no need to define axes.
.. i18n: * No intervention at all from developers: everything through interfaces for end-user. 
...
.. i18n: * Everything (dimensions, ) must be object oriented with a module system to allow to add your own code to extend the software, like in Open  ERP.
...
.. i18n: .. and Open ERP Press was aware of a trademark claim, the designations have been
...
.. i18n: .. Published by Open ERP Press, Grand Rosière, Belgium
