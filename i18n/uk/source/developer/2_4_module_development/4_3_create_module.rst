...
.. i18n: Creating a new module is quickly done by copying the module called "simple" or
.. i18n: "custom" (depending on your OpenERP version) into a new directory.
...
.. i18n: ::
.. i18n: 
.. i18n:     $ cd /usr/lib/openerp-server/addons/
...
.. i18n: To change the default settings of the custom module (which is now the "travel" module),
.. i18n: get yourself into the "travel" directory and edit *__terp__.py* (with *gedit*,
...
.. i18n: Now you need to update the custom.py script to suit the needs of your module.
...
.. i18n: The '#' signs represent comments. You'll have to remove them, rename the class
.. i18n: and its attributes to something like this:
...
.. i18n: right, we recommend, once again, that you take a look at the 20 minutes Flash
.. i18n: tutorial or download the travel agency module example.
