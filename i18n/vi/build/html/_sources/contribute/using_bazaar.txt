...
.. i18n: When commiting your work to Launchpad, please respect these policies:
...
.. i18n: The new features (+the bugfixes on these new functionalities) have to be done
...
.. i18n: the commit message. We have to show respect for them and for their work, so
...
.. i18n:   functionalities or behavior. See http://en.wikipedia.org/wiki/Refactoring for
...
.. i18n:   *"bugfix"* or *"improvements"* anymore! (the only single word commit messgae
...
.. i18n: different commits where impacted modules are differents (It will be
