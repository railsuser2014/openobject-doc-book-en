...
.. i18n:   *This chapter describes Open ERP's sales management, following the complete sales order process from
.. i18n:   quotation to customer order, including the management of deliveries and of invoicing. 
.. i18n:   It doesn't look at customer relations and pre-sales, which are handled by the CRM
.. i18n:   (Customer Relationship Management) modules described in an earlier part of the book.*
.. i18n:   
.. i18n:   *It also describes the management of carriers, margin control and reporting, and
.. i18n:   price management and the handling of various types of sales discount campaign.*
.. i18n:   
