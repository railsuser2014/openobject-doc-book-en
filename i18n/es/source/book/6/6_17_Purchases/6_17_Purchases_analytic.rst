...
.. i18n: To manage purchases by project you should use the analytic accounts. 
...
.. i18n: by Open ERP from the goods receipt and confirmation of the supplier invoice.
...
.. i18n: The :mod:`hr_timesheet_invoice` module lets you reinvoice the analytic costs automatically using
...
.. i18n: So you can put an invoice order with a defined invoice workflow in place based on the analytic accounts. If you're
...
.. i18n: When re-invoicing based on costs you'd get the following workflow:
...
.. i18n:    plans.
.. i18n:    Look back at :ref:`ch-accts` for more information on the use of analytic accounts.
