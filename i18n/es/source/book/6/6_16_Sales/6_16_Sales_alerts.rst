...
.. i18n: be attached to the person setting off the event. The different available events on the partner form
.. i18n: are:
...
.. i18n: * Entering a customer order for the partner,
.. i18n: 
.. i18n: * Entering a supplier order for the partner,
.. i18n: 
.. i18n: * Sending a delivery to the partner (or receiving an item),
.. i18n: 
.. i18n: * Invoicing a partner.
...
.. i18n: The alerts that can be configured on a product form are:

The alerts that can be configured on a product form are:

.. i18n: * The sale of that product,
.. i18n: 
