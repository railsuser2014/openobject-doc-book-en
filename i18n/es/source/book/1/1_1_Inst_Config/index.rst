...
.. i18n:  
.. i18n: .. figure:: images/ch1_outline.png
.. i18n:    :align: center
.. i18n: 
...
.. i18n: This chapter, :ref:`ch-inst`, focuses on the installation of Open ERP so that you can begin to familiarize
.. i18n: yourselves with its use. If you're not a systems administrator, or if you've already installed
.. i18n: Open ERP, or if you're planning to use an online SaaS provider, then you can skip this chapter and
.. i18n: move straight to the next chapter, :ref:`ch-guided`. If you've already used Open ERP (or Tiny ERP) a bit then you can move
.. i18n: past that to the third chapter in this part of the book, :ref:`ch-real`.
