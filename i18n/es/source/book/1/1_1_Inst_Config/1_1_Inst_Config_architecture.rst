...
.. i18n: 
.. i18n:     The main functional difference between the two Open ERP clients is the
.. i18n:     presence of the calendar view in the web client, which doesn't exist in the
.. i18n:     GTK client at present (versions 4.x and 5.0). Apart from that you will find that
.. i18n:     there are small differences in their general usability.
.. i18n:     
