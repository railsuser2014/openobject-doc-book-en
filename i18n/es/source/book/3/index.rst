...
.. i18n:  When it's well integrated with the management system, an accounting system offers a company special
...
.. i18n:  Open ERP's accounting modules enable you not only to manage your operations clearly,
.. i18n:  following the workflow through from invoicing to payment,
.. i18n:  but also to use various tools for financial analysis based on both real-time data and recent history
