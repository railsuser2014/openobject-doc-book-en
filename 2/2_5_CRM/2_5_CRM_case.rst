...
.. note:: Case
	...
	operations in response to certain conditions. Interfaces are available for
	email clients such as Microsoft Outlook or Thunderbird, so that you can make productive use
